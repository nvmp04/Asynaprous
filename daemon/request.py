...
class Request():
    ...
    def prepare(self, request, routes=None):
        ...
        if not routes == {}:
            ...
            print("[Debug] method={} path={} hook={}".format(self.method, self.path, self.hook))
        ...
        self.cookies = {} # Khởi tạo là dict trống
    ...
    def prepare_auth(self, auth=None, url=""):
        ...
        if auth_header and auth_header.lower().startswith('basic '):
            try:
                ...
                if ':' in decoded_creds:
                    self.auth = tuple(decoded_creds.split(':', 1))
                    return self.auth
            except Exception as e:
                print(f"[Request] Decode Auth Error: {e}")
